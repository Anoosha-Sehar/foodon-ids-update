...
def main():
    ...
    for i in range(0,len(lines)):
        if "NCBITaxon_" in lines[i] and " #" in lines[i]:
            subject = lines[i][lines[i].index("NCBITaxon_"):lines[
                i].index(
                " #")]
